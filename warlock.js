...
// Generated by CoffeeScript 1.3.3
(function() {
  var Transaction, cloneObj, getId, isBrowser,
    _this = this,
    __hasProp = {}.hasOwnProperty,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  ...
  Transaction = (function() {
    ...
    function Transaction(fn, parent) {
      this.fn = fn;
      this.parent = parent;
      this.doTrans = __bind(this.doTrans, this);
    ...
    Transaction.prototype.run = function(cb) {
      var _this = this;
      if (this.parent.hasSynced) {
        return this.doTrans(cb);
      } else {
        return this.parent.once('sync', function() {
          return _this.doTrans(cb);
        });
      }
    };

    Transaction.prototype.doTrans = function(cb) {
      var ctx,
        _this = this;
      this.root = cloneObj(this.parent.root);
      ctx = {
        get: function(k) {
          return cloneObj(_this.root[k]);
        },
        set: function(k, v) {
          var _base, _ref;
          if ((_ref = (_base = _this.log)[k]) == null) {
            _base[k] = {
              current: ctx.get(k)
            };
          }
        ...
        retry: function() {
          return _this.parent.once('sync', ctx.restart);
        },
        restart: function() {
          _this.parent.removeAllListeners("failed." + _this.id);
          _this.parent.removeAllListeners("complete." + _this.id);
          _this.log = {};
          _this.root = {};
          return _this.run(cb);
        },
        abort: function(msg) {
          ...
          if (cb != null) {
            _this.parent.once("complete." + _this.id, cb);
          }
          _this.parent.once("failed." + _this.id, ctx.restart);
          return _this.parent.ssocket.write({
            type: 'transaction',
            id: _this.id,
            log: _this.log
          });
...
// Generated by CoffeeScript 1.3.3
(function() {
  var Transaction, client, isBrowser;
